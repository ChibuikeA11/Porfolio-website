  ...
  return (
    <div name='contact' className='w-full md:h-screen bg-slate-950 flex justify-center items-center p-4'>
      <form onSubmit={sendEmail} className='flex flex-col max-w-[800px] w-full h-full'>
        ...
        <input className='bg-[#ccd6f6] p-2' type='user_name' placeholder='Name' name='user_name' />
        <input className='my-4 p-2 bg-[#ccd6f6]' type='email-address' placeholder='Email' name='email-address' required />
